function [err, bim, cim, sim, xc, yc, bc, cc, sc, len, imm, imm_c, maskrand] = radialpatterns_random(tag, pattern, pixel, NA, n0, n, n1, d0, d, d1, lamex, focpos, pic)
% radialpatterns_random computes patterns for randomly oriented molecules
% for the givel pixel size and the excitation wavelength and then 
% identifies molecules by calling FindPatternSep.m
...
%     end
   ...
   [err, bim, cim, sim, xc, yc, bc, cc, sc, len, imm, imm_c] = FindPatternSep(tag,maskrand,maskrand>0,[],[],tresh,[],0);
