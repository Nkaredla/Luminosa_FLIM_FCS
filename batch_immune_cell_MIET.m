...
function row = addResultQc(row, result, qc)
    ...
    if isfield(result, 'bayesian') && ...
        ...
        orderedSummary = result.bayesian.orderedComponents.summary;
    ...
    if isfield(result, 'spatialBinning') && ...
        ...
        binnedSummary = ...
            result.spatialBinning.bayesian.orderedComponents.summary;
    ...
    if isfield(result, 'spatialBinning4x4') && ...
        ...
        binned4x4Summary = ...
            result.spatialBinning4x4.bayesian.orderedComponents.summary;
...
function usable = existingResultUsable(matFile, result, requireTcspcPix, ...
    ...
    usable = isfield(result, 'segmentation') && ...
        ...
        double(result.analysisSchemaVersion) >= 6 && ...
        isfield(result.segmentation, 'diagnostics') && ...
    ...
    fixedCountRequired = isfield(expectedConfig, 'fixSlbAmplitude') && ...
    ...
    if fixedCountRequired && ~(isfield(result.bayesian, 'compact') && ...
            ...
            strcmp(result.bayesian.compact.fixedSlbPhotonConstraint.mode, ...
                'direct expected photon-count allocation') && ...
    ...
    if componentFiguresRequired
        figureFields = {'secondSortedLifetimePng', ...
            'thirdSortedLifetimePng', 'sortedLifetimeLayersPng'};
