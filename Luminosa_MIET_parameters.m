classdef Luminosa_MIET_parameters < handle
...
% (c) Daja Ruhlandt 2014
    ...
    methods
        ...
        function app = Luminosa_MIET_parameters(varargin)  % "constructor" (can accept structure with parameter values as input)
        ...
        function SaveSettingsCallback(app,~,~) % save refr. indices, thicknesses, z-parameters
            ...
            % read setup parameters from the GUI
                ...
                save([path file],'monochrome','n1','d1','n0','d0','n','d','QY','dipoleOrientation','lambda',...
